...
local Notice = library:Window("Notice") -- Notice
...
Teleports:Button("Town Hall", function()
    pos = "-354, 3, -85"
    game:GetService("Players").LocalPlayer.Character:MoveTo(pos)
end)
...
Teleports:Button("Daycare", function()
    pos = "-155, 4, 165"
    game:GetService("Players").LocalPlayer.Character:MoveTo(pos)
end)
...
-- Notice
Notice:Label(
    "I wasn't able to implement many features because this game is lame as fuckkk")
